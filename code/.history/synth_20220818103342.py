...
if __name__=="__main__":
    ...
    #颜色赋值
    col = []
    colors = ['#FF0000', '#FFA500', 'black', 'blue', '#228B22']
    ...
    df.plot.scatter('index', 'X', c=col, figsize=(16,5))

    # plt.plot(Z+120)
    plt.subplots_adjust(top = 1, bottom = 0, right = 1, left = 0, hspace = 0, wspace = 0)
    plt.margins(0,0)
    plt.show()
    plt.savefig("genworkmode/dwell_color.png", transparent=True, dpi=300, pad_inches = 0)
