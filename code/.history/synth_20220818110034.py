...
if __name__=="__main__":
    ...
    plt.plot(range(len(X1)), X1,color='black', linewidth=1.0)
    plt.scatter(range(len(X1)), X1, c=col,marker='*',s=16)
    # ax = df.plot.scatter('index', 'X', c=col, figsize=(16,5),s=6)
    # ax = df.plot('index', 'X', c='black')
