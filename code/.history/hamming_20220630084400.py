...
def hamming_distance(z_true,z_hat):
    z_hat_align = alignEstimatedStateSeqToTruth(z_true, z_hat)
    hdistance = calcHammingDistance(z_ture, z_hat_align)
    normhdist = float(hdistance) / float(z_hat_align.size)
