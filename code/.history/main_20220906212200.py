...
from synth import workmode_cat, center_compare, trans_compare, hinton, calculate_FAR_ADD
...
for threshold in thresholds:
    ...
    FAR, ADD = calculate_FAR_ADD(bkps, bkps_truth)
    FARs.append(FAR)
    ADDs.append(ADD)

#%%
curve = np.vstack((FARs,ADDs))
np.savetxt("curves/FSS_001.csv", curve, delimiter=",") 
